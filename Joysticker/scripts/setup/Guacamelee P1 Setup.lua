...
--input is triggered
local setup = Map {["Left"] = Keys.Left, ["Right"] = Keys.Right, ["Up"] = Keys.Up, ["Down"] = Keys.Down,
["Jump"] = Keys.S, ["Attack"] = Keys.A, ["Special"] = Keys.D, ["Grab"] = Keys.W, ["Dodge"] = Keys.LShift,
...
JS.SetupKeys(setup, "GuacameleePlayer1.lua")
